...
// In this activity I worked with else... if statements. I learned that these statements come after the if statement and allow for more than 2 possible outcomes.
// They read  from top to bottom. The first condition that evaluates to true from the top to bottom is the block that gets executed. 
// If none of the conditions evaluate to true, then the code in the else statement will execute.
